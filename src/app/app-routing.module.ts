...
const routes: Routes = [
  ...
  },
  {
    path: 'nuevo-usuario',
    loadChildren: () =>
      import('@components/nuevo-usuario/nuevo-usuario.module').then(
  ...
  },
  {
    ...
    loadChildren: () =>
      import('@components/verificar-usuario/verificar-usuario.module').then(
        m => m.VerificarUsuarioModule
      ),
    data: {
      showHeader: false,
      showSidebar: false,
  ...
  },
  {
    path: 'perfil',
    loadChildren: () =>
      import('@components/perfil/pefil.module').then(m => m.PefilModule),
    data: {
      breadcrumb: 'Perfil',
    },
  },
  ...
  },
  {
    path: 'pedidos',
    loadChildren: () =>
      import('@components/pedidos/pedidos.module').then(m => m.PedidosModule),
    data: {
      breadcrumb: 'Pedidos',
    },
  },
  {
    path: 'deliveries',
    loadChildren: () =>
      import('@components/deliveries/deliveries.module').then(
  ...
  },
  {
    path: 'sucursales',
    loadChildren: () =>
      import('@components/sucursales/sucursales.module').then(
